...
description: "B2B Import ERP has 30+ ordered SQL migrations in supabase/migrations/. Apply them in sequence using Supabase CLI or the SQL editor to provision a new database."
---
