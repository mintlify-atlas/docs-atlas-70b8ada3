...
description: "Pure engineering and pricing utilities for B2B Import ERP. Computes CFM airflow, motor power, noise, equipment count, and COP/USD budgetary price ranges."
---
...
<ParamField path="altitudeMsnm" type="number" required>
  Altitude in metres above sea level. `0` = sea level (standard density 1.204 kg/m³ at 20 °C).
</ParamField>

<ParamField path="tempCelsius" type="number" required>
