...
<Steps>
  ...
  <Step title="Run database migrations">
    ...
    **Option B — Supabase Dashboard SQL Editor:**
    ...
    Navigate to your project's SQL Editor and run each file from `supabase/migrations/` in ascending filename order (migrations are prefixed with a timestamp, e.g. `20260501000001_...sql`).
