---
title: "Clients Module: Manage B2B Companies and Contacts"
sidebarTitle: "Clients"
description: "The Clients module manages the full lifecycle of B2B companies and contacts — from prospect intake through active, inactive, and archived states with full audit trail."
---
...
|---|---|
| **View clients** | All authenticated users of the tenant (`clients_select_tenant`) |
| **Create client** | `EJECUTIVO_COMERCIAL`, `DIRECTOR_COMERCIAL`, `GERENTE_GENERAL`, `SUPER_ADMIN` |
| **Edit client** | `EJECUTIVO_COMERCIAL`, `DIRECTOR_COMERCIAL`, `GERENTE_GENERAL`, `SUPER_ADMIN` |
| **Change status** | `EJECUTIVO_COMERCIAL`, `DIRECTOR_COMERCIAL`, `GERENTE_GENERAL`, `SUPER_ADMIN` |
| **View soft-deleted records** | `AUDITOR`, `SUPER_ADMIN` |
