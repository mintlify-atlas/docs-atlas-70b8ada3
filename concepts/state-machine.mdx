...
<Note>
  All state names are in **Spanish** because B2B Import ERP is built for Spanish-speaking markets in Latin America. State codes stored in the database match the Spanish names exactly (e.g., `"Prospecto"`, `"En Ejecución"`, `"Borrador"`).
</Note>
